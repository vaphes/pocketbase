...
from pocketbase.models.base_model import Model
...
class CrudService(Generic[T], BaseService, ABC):
    ...
    def get_full_list(
        ...
        """
        Returns all list items batch fetched at once (by default 500 items
        per request; to change it set the `batch` query param).
        """
        result: list[T] = []
